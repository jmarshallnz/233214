...
Today we'll be using the `tidyverse` for ggplot charts, `sparr` for our spatial analyses, and will use `raster` and `maptools` for loading up a pixel image. Let's load them:
