...
1. We estimate a **spatial trend** using a standard statistical model (e.g. model the average spatial trend in terms of longitude and latitude or some covariates).
